...
fn testCompletionWithOptions(
    ...
    for (found.keys()) |label| {
        ...
        if (expected_completion.documentation) |expected_doc| doc_blk: {
            ...
            try error_builder.msgAtIndex("completion item '{s}' has unexpected doc '{f}'", test_uri, cursor_idx, .err, .{
                label,
        ...
        if (expected_completion.detail) |expected_detail| blk: {
            ...
            try error_builder.msgAtIndex("completion item '{s}' has unexpected detail '{s}'", test_uri, cursor_idx, .err, .{
                label,
                actual_detail,
            });
            return error.InvalidCompletionDetail;
        ...
        if (expected_completion.labelDetails) |expected_label_details| {
            ...
            try error_builder.msgAtIndex("completion item '{s}' has unexpected label details", test_uri, cursor_idx, .err, .{
                label,
            });
            return error.InvalidCompletionLabelDetails;
        }
