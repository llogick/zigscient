...
//! `zig build --build-runner src/build_runner/legacy.zig`
//!
//! You can also test the build runner on any other `build.zig` with the following command:
//! `zig build --build-file /path/to/build.zig --build-runner /path/to/zls/src/build_runner/legacy.zig`
//! `zig build --build-runner /path/to/zls/src/build_runner/legacy.zig` (if the cwd contains build.zig)
//!
