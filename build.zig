...
pub fn build(b: *std.Build) !void {
    ...
    const version_slice = bzz.compiler_internals_version;
...
fn cfgLspServer(
    ...
    const ls_test_options = blk: {
        ...
        ls_test_options.addOptionPathDirectory("zig_lib_path", .zig_lib);
        ls_test_options.addOptionPathDirectory("global_cache_path", .{ .relative = .{ .base = .global_cache } });
